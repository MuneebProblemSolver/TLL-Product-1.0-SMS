...
const SignIn = () => {
  ...
  const [error, setError] = useState(''); // Retain this state for showing error messages
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError('Invalid email or password'); // Set the error message on failure
    }
  };
  ...
  return (
    <Stack mx="auto" direction="column" alignItems="center" width={1} maxWidth={450}>
      ...
      <Divider sx={{ my: 4.5 }}>Trakie By The Logic Lounge</Divider>
